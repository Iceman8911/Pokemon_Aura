...
static const u8 sText_Speed2[] = _("Speed");
static const u8 sText_SpAttack2[] = _("Sp. attack");
static const u8 sText_SpDefense2[] = _("Sp. defense");
...
const u8 *const gStatNamesTable[NUM_BATTLE_STATS] =
{
    ...
    sText_Speed2, sText_SpAttack2, sText_SpDefense2,
...
const struct BattleWindowText gTextOnWindowsInfo_Normal[] =
{
    ...
    [B_WIN_SUPER_EFFECTIVE] = { // 24 "type" super-effective
        .fillValue = PIXEL_FILL(0xE),
        .fontId = FONT_NORMAL,
        .x = 0,
        .y = 1,
    ...
    [B_WIN_NOT_VERY_EFFECTIVE] = { // 25 "type" not very effective
        .fillValue = PIXEL_FILL(0xE),
        .fontId = FONT_NORMAL,
        .x = 0,
        .y = 1,
    ...
    [B_WIN_NO_EFFECT] = { // 26 "type" no effect
        .fillValue = PIXEL_FILL(0xE),
        .fontId = FONT_NORMAL,
        .x = 0,
        .y = 1,
    ...
    while (*src != EOS)
    {
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_PARTNER_NAME:
                ...
                break;
            case B_TXT_SIBLING_NAME:
                toCpy = gSaveBlock2Ptr->siblingName;
