...
static void PrintBerryNumberAndName(void)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_NumberVar1Var2);
    PrintTextInBerryTagScreen(WIN_BERRY_NAME, gSystemStringVar, 0, 1, 0, 0);
}
...
static void PrintBerrySize(void)
{
    ...
    if (berry->size != 0)
    {
        ...
        StringExpandPlaceholders(gSystemStringVar, gText_Var1DotVar2);
        AddTextPrinterParameterized(WIN_SIZE_FIRM, FONT_NORMAL, gSystemStringVar, 0x28, 1, 0, NULL);
    }
    else
    {
