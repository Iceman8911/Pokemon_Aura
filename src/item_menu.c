...
static void BagMenu_ItemPrintCallback(u8 windowId, u32 itemIndex, u8 y)
{
    ...
    if (itemIndex != LIST_CANCEL)
    {
        ...
        if (gBagPosition.pocket == BERRIES_POCKET)
        {
            ...
            StringExpandPlaceholders(gSystemStringVar, gText_xVar1);
            offset = GetStringRightAlignXOffset(FONT_NARROW, gSystemStringVar, 119);
            BagMenu_Print(windowId, FONT_NARROW, gSystemStringVar, offset, y, 0, 0, TEXT_SKIP_DRAW, COLORID_NORMAL);
        }
...
static void PrintItemDescription(int itemIndex)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gSystemStringVar, gText_ReturnToVar1);
        str = gSystemStringVar;
    }
...
static void PrintItemQuantity(u8 windowId, s16 quantity)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gSystemStringVar, GetStringCenterAlignXOffset(FONT_NORMAL, gSystemStringVar, 0x28), 2, 0, 0);
}
...
static void PrintItemSoldAmount(int windowId, int numSold, int moneyEarned)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gSystemStringVar, 0, 1, TEXT_SKIP_DRAW, 0);
...
static void StartItemSwap(u8 taskId)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_MoveVar1Where);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void OpenContextMenu(u8 taskId)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gSystemStringVar, gText_Var1IsSelected);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
    }
...
static void ItemMenu_Toss(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gSystemStringVar, gText_TossHowManyVar1s);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void AskTossItems(u8 taskId)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_ConfirmTossItems);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void ConfirmToss(u8 taskId)
{
    ...
    CopyItemName(gSpecialVar_ItemId, gStringVar1);
    ConvertIntToDecimalStringN(gStringVar2, tItemCount, STR_CONV_MODE_LEFT_ALIGN, MAX_ITEM_DIGITS);
    StringExpandPlaceholders(gSystemStringVar, gText_ThrewAwayVar2Var1s);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
{
    CopyItemName(gSpecialVar_ItemId, gStringVar1);
    StringExpandPlaceholders(gSystemStringVar, gText_Var1CantBeHeld);
    DisplayItemMessage(taskId, FONT_NORMAL, gSystemStringVar, HandleErrorMessage);
}
...
static void Task_ItemContext_GiveToParty(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gSystemStringVar, gText_Var1CantBeHeldHere);
        DisplayItemMessage(taskId, FONT_NORMAL, gSystemStringVar, HandleErrorMessage);
    }
...
static void Task_ItemContext_Sell(u8 taskId)
{
    ...
    if (ItemId_GetPrice(gSpecialVar_ItemId) == 0)
    {
        ...
        StringExpandPlaceholders(gSystemStringVar, gText_CantBuyKeyItem);
    ...
    else
    {
        ...
        {
            CopyItemName(gSpecialVar_ItemId, gStringVar2);
            StringExpandPlaceholders(gSystemStringVar, gText_HowManyToSell);
            DisplayItemMessage(taskId, FONT_NORMAL, gSystemStringVar, InitSellHowManyInput);
        }
    }
}
...
static void DisplaySellItemPriceAndConfirm(u8 taskId)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_ICanPayVar1);
    DisplayItemMessage(taskId, FONT_NORMAL, gSystemStringVar, AskSellItems);
}
...
static void ConfirmSell(u8 taskId)
{
    ...
    CopyItemName(gSpecialVar_ItemId, gStringVar2);
    ConvertIntToDecimalStringN(gStringVar1, (ItemId_GetPrice(gSpecialVar_ItemId) / 2) * tItemCount, STR_CONV_MODE_LEFT_ALIGN, 6);
    StringExpandPlaceholders(gSystemStringVar, gText_TurnedOverVar1ForVar2);
    DisplayItemMessage(taskId, FONT_NORMAL, gSystemStringVar, SellItem);
}
...
static void Task_ItemContext_Deposit(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gSystemStringVar, gText_DepositHowManyVar1);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
        AddItemQuantityWindow(ITEMWIN_QUANTITY);
...
static void TryDepositItem(u8 taskId)
{
    ...
    else if (AddPCItem(gSpecialVar_ItemId, tItemCount) == TRUE)
    {
        ...
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        ConvertIntToDecimalStringN(gStringVar2, tItemCount, STR_CONV_MODE_LEFT_ALIGN, MAX_ITEM_DIGITS);
        StringExpandPlaceholders(gSystemStringVar, gText_DepositedVar2Var1s);
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gSystemStringVar, 3, 1, 0, 0, 0, COLORID_NORMAL);
        gTasks[taskId].func = Task_RemoveItemFromBag;
    }
    else
