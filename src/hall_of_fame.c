...
static void Task_HofPC_DrawSpritesPrintText(u8 taskId)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_HOFNumber);

    if (gTasks[taskId].tCurrTeamNo <= 0)
        HofPCTopBar_PrintPair(gSystemStringVar, gText_PickCancel, FALSE, 0, TRUE);
    else
        HofPCTopBar_PrintPair(gSystemStringVar, gText_PickNextCancel, FALSE, 0, TRUE);
