static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ANCONNA_TOWN - 1] = {MAP_GROUP(ANCONNA_TOWN), MAP_NUM(ANCONNA_TOWN), 6, 18},
    [HEAL_LOCATION_SCANDI_CITY - 1] = {MAP_GROUP(SCANDI_CITY), MAP_NUM(SCANDI_CITY), 10, 10},
};
