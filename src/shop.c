...
static void BuyMenuPrintPriceInList(u8 windowId, u32 itemId, u8 y)
{
    ...
    if (itemId != LIST_CANCEL)
    {
        ...
        x = GetStringRightAlignXOffset(FONT_NARROW, gSystemStringVar, 0x78);
        AddTextPrinterParameterized4(windowId, FONT_NARROW, x, y, 0, 0, sShopBuyMenuTextColors[1], TEXT_SKIP_DRAW, gSystemStringVar);
    }
}
...
static void Task_BuyHowManyDialogueInit(u8 taskId)
{
    ...
    BuyMenuPrint(3, gSystemStringVar, 0, 1, 0, 0);
    tItemCount = 1;
...
static void BuyMenuPrintItemQuantityAndPrice(u8 taskId)
{
    ...
    BuyMenuPrint(4, gSystemStringVar, 0, 1, 0, 0);
}
