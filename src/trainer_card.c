...
static void PrintMoneyOnCard(void)
{
    ...
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_NORMAL, xOffset, top, sTrainerCardTextColors, TEXT_SKIP_DRAW, gSystemStringVar);
}
...
static void PrintTimeOnCard(void)
{
    ...
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_NORMAL, x, y, sTrainerCardTextColors, TEXT_SKIP_DRAW, gSystemStringVar);
    x += 18;
