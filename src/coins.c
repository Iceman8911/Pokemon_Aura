...
void PrintCoinsString(u32 coinAmount)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_Coins);

    xAlign = GetStringRightAlignXOffset(FONT_NORMAL, gSystemStringVar, 0x40);
    AddTextPrinterParameterized(sCoinsWindowId, FONT_NORMAL, gSystemStringVar, xAlign, 1, 0, NULL);
}
