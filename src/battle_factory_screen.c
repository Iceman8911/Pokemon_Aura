...
static void Select_PrintMonSpecies(void)
{
    ...
    StringCopy(gSystemStringVar, gSpeciesNames[species]);
    x = GetStringRightAlignXOffset(FONT_NORMAL, gSystemStringVar, 86);
    AddTextPrinterParameterized3(SELECT_WIN_SPECIES, FONT_NORMAL, x, 1, sSpeciesNameTextColors, 0, gSystemStringVar);
...
static void Swap_PrintMonSpecies(void)
{
    ...
    else
    {
        ...
        StringCopy(gSystemStringVar, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gSystemStringVar, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gSystemStringVar);
...
static void Swap_PrintMonSpeciesAtFade(void)
{
    ...
    else
    {
        ...
        StringCopy(gSystemStringVar, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gSystemStringVar, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES_AT_FADE, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gSystemStringVar);
        CopyWindowToVram(SWAP_WIN_SPECIES_AT_FADE, COPYWIN_FULL);
    }
}
