...
static const struct WindowTemplate sStandardBattleWindowTemplates[] =
{
    ...
    [B_WIN_PP] = {
        .bg = 0,
        .tilemapLeft = 23, //Shift to the right a bit to make space for the split battle icons
        .tilemapTop = 55,
        .width = 2,
        .height = 2,
        .paletteNum = 5,
    ...
    [B_WIN_PSS_BATTLE_ICONS] = {
        ...
        .width = 2,
        .height = 2,
        .paletteNum = 10,  // Use a free palette for the split battle icons
        .baseBlock = 0x0294,
    },
    [B_WIN_PP_REMAINING] = {
        .bg = 0,
    ...
    [B_WIN_SUPER_EFFECTIVE] = { // super effective
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
    ...
    [B_WIN_NOT_VERY_EFFECTIVE] = { // not very effective
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
    ...
    // For stab moves
    [B_WIN_SUPER_EFFECTIVE_STAB] = { // super effective with STAB
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
    ...
    [B_WIN_NOT_VERY_EFFECTIVE_STAB] = { // not very effective with STAB
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
    ...
    [B_WIN_NO_EFFECT_STAB] = { // no effect with STAB
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
