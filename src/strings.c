...
const u8 gText_SuperEffective[] = _(" {UP_ARROW}");
const u8 gText_NotVeryEffective[] = _(" {DOWN_ARROW}");
const u8 gText_NoEffect[] = _(" X");
...
const u8 gText_PkmnFainted_FldPsn[] = _("FILL STUFF HERE");
...
const u8 gText_SideQuestName_FIND_BIBBYS_COMB[] = _("Where's The Comb?");
...
const u8 gText_SideQuestDesc_FIND_BIBBYS_COMB[] = _("Search Downstairs for the missing comb.");
...
const u8 gText_SideQuestDoneDesc_FIND_BIBBYS_COMB[] = _("How did it end up in a bin..\nAt least we found it.");
...
const u8 gText_SideQuestMap_FIND_BIBBYS_COMB[] = _("Home");
