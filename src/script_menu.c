...
static void CreatePCMultichoice(void)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_PlayersPC);
    //PrintPlayerNameOnWindow(windowId, gSystemStringVar, y, 17);
    //StringExpandPlaceholders(gSystemStringVar, gText_PlayersPC);
    PrintPlayerNameOnWindow(windowId, gSystemStringVar, x, 17);
