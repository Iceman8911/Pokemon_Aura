...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    StringExpandPlaceholders(gSystemStringVar, gText_ThrowAwayVar1);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gSystemStringVar, CreateTossPokeblockYesNoMenu);
}
...
{
    StringExpandPlaceholders(gSystemStringVar, gText_Var1ThrownAway);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gSystemStringVar, TossPokeblock);
}
